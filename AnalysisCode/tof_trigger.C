...
// FTOF_Panel_1A
   ...
   vector<double> *tof_ADC=new vector<double>;
...
// FTOF_Panel_1A
   ...
   tof->SetBranchAddress("ADC"   ,&tof_ADC);
...
// Create histos
   ...
   TH1F *hi_tof_pid = new TH1F("hi_tof_pid", "hi_tof_pid",3000, -600.,2400.);
   hi_tof_pid->GetXaxis()->SetTitle("PID");
   hi_tof_pid->GetYaxis()->SetTitle("Rate (MHz)");

   TH1F *hi_tof_pid_5 = new TH1F("hi_tof_pid_5", "hi_tof_pid_5",3000, -600.,2400.);
   hi_tof_pid_5->GetXaxis()->SetTitle("PID");
   hi_tof_pid_5->GetYaxis()->SetTitle("Rate (MHz)");

   TH1F *hi_tof1a_pid = new TH1F("hi_tof1a_pid", "hi_tof1a_pid",200, -600.,2400.);
   hi_tof1a_pid->GetXaxis()->SetTitle("PID");
   hi_tof1a_pid->GetYaxis()->SetTitle("Rate (MHz)");

   TH1F *hi_tof1b_pid = new TH1F("hi_tof1b_pid", "hi_tof1b_pid",200, -600.,2400.);
   hi_tof1b_pid->GetXaxis()->SetTitle("PID");
   hi_tof1b_pid->GetYaxis()->SetTitle("Rate (MHz)");

   TH1F *hi_tof2_pid = new TH1F("hi_tof2_pid", "hi_tof2_pid",200, -600.,2400.);
   hi_tof2_pid->GetXaxis()->SetTitle("PID");
   hi_tof2_pid->GetYaxis()->SetTitle("Rate (MHz)");

   TH1F *hi_tof1a_pid_5 = new TH1F("hi_tof1a_pid_5", "hi_tof1a_pid_5",200, -600.,2400.);
   hi_tof1a_pid_5->GetXaxis()->SetTitle("PID");
   hi_tof1a_pid_5->GetYaxis()->SetTitle("Rate (MHz)");

   TH1F *hi_tof1b_pid_5 = new TH1F("hi_tof1b_pid_5", "hi_tof1b_pid_5",200, -600.,2400.);
...
// in luminosity mode (50*2300 or 118600 electrons in 250ns window)
   ...
   for (Long64_t jentry=0; jentry < nentries; jentry++) {
	 ...
	 double weightADC =  (*tof_ADC)[i]*(3.0)*(0.242E-3)*(4E-3/50);
...
// in luminosity mode (50*2300 or 118600 electrons in 250ns window)
  ...
  // hi_tof_occ_5charged->Draw("COLZ");
   ...
   gPad->SetLogy();
   hi_tof_pid_5->Draw("H");
   c_pid0->Print("tof_occupancy.pdf");
   ...
   c_particles->Print("tof_occupancy.pdf");
    ...
    gPad->SetLogz();
     ...
     c_origin_e->Print("tof_occupancy.pdf");

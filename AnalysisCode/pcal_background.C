...
// Create histos
   ...
   for(int i=0; i<3; i++) {
       int nstrip=68;
       if(i>0) nstrip=36;
       hi_pcal_occ[i] = new TH2F(Form("hi_pcal_occ %d",i+1), Form("hi_pcal_occ %d",i+1),nstrip, 1.,nstrip*1.+1.,3,1.,4.);
       hi_pcal_occ[i]->GetXaxis()->SetTitle("Strip");
       hi_pcal_occ[i]->GetYaxis()->SetTitle("View");
       hi_pcal_occ_cut[i] = new TH2F(Form("hi_pcal_occ_cut %d",i+1), Form("hi_pcal_occ_cut %d",i+1),nstrip, 1.,nstrip*1.+1.,3,1.,4.);
       hi_pcal_occ_cut[i]->GetXaxis()->SetTitle("Strip");
       hi_pcal_occ_cut[i]->GetYaxis()->SetTitle("View");
       hi_pcal_vz_all[i] = new TH1F(Form("hi_pcal_vz_all %d",i+1), Form("hi_pcal_vz_all %d",i+1),300, 0., 900.);
       hi_pcal_vz_all[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_all[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_e[i] = new TH1F(Form("hi_pcal_vz_e %d",i+1), Form("hi_pcal_vz_e %d",i+1),300, 0., 900.);
       hi_pcal_vz_e[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_e[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_g[i] = new TH1F(Form("hi_pcal_vz_g %d",i+1),Form("hi_pcal_vz_g %d",i+1),300, 0., 900.);
       hi_pcal_vz_g[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_g[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_h[i] = new TH1F(Form("hi_pcal_vz_h %d",i+1), Form("hi_pcal_vz_h %d",i+1),300, 0., 900.);
       hi_pcal_vz_h[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_h[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_n[i] = new TH1F(Form("hi_pcal_vz_n %d",i+1), Form("hi_pcal_vz_n %d",i+1),300, 0., 900.);
       hi_pcal_vz_n[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_n[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_origin_all[i] = new TH2F(Form("hi_pcal_origin_all %d",i+1), Form("hi_pcal_origin_all %d",i+1),300, 0., 900.,200, 0., 600.);
       hi_pcal_origin_all[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_origin_all[i]->GetYaxis()->SetTitle("R_{vertex} (cm)");
       hi_pcal_edep[i] = new TH1F(Form("hi_pcal_edep %d",i+1), Form("hi_pcal_edep %d",i+1),200, 0.,10.);

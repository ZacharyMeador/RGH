...
// Create histos
   TH2F *hi_pcal_occ1[6];
   TH2F *hi_pcal_occ_cut1[6]; 
   TH1F *hi_pcal_vz_all1[6];
   TH1F *hi_pcal_vz_e1[6];
   TH1F *hi_pcal_vz_g1[6];
   TH1F *hi_pcal_vz_h1[6];
   TH1F *hi_pcal_vz_n1[6];
   TH2F *hi_pcal_origin_all1[6]; 
   TH1F *hi_pcal_edep1[6];
   TH2F *hi_pcal_occ2[6];
   TH2F *hi_pcal_occ_cut2[6];
   TH1F *hi_pcal_vz_all2[6];
   TH1F *hi_pcal_vz_e2[6];
   TH1F *hi_pcal_vz_g2[6];
   TH1F *hi_pcal_vz_h2[6];
   TH1F *hi_pcal_vz_n2[6];
   TH2F *hi_pcal_origin_all2[6];
   TH1F *hi_pcal_edep2[6];
   TH2F *hi_pcal_occ3[6];
   TH2F *hi_pcal_occ_cut3[6];
   TH1F *hi_pcal_vz_all3[6];
   TH1F *hi_pcal_vz_e3[6];
   TH1F *hi_pcal_vz_g3[6];
   TH1F *hi_pcal_vz_h3[6];
   TH1F *hi_pcal_vz_n3[6];
   TH2F *hi_pcal_origin_all3[6];
   TH1F *hi_pcal_edep3[6]; 
   ...
   for(int i=0; i<6; i++) {
       ...
       hi_pcal_occ2[i]->GetXaxis()->SetTitle("Strip");
       hi_pcal_occ2[i]->GetYaxis()->SetTitle("View");
       hi_pcal_occ_cut2[i] = new TH2F(Form("hi_pcal_occ_cut_layer2 %d",i+1), Form("hi_pcal_occ_cut_layer2 %d",i+1),nstrip, 1.,nstrip*1.+1.,3,1.,4.);
       hi_pcal_occ_cut2[i]->GetXaxis()->SetTitle("Strip");
       hi_pcal_occ_cut2[i]->GetYaxis()->SetTitle("View");
       hi_pcal_vz_all2[i] = new TH1F(Form("hi_pcal_vz_all_layer2 %d",i+1), Form("hi_pcal_vz_all_layer2 %d",i+1),300, 0., 900.);
       hi_pcal_vz_all2[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_all2[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_e2[i] = new TH1F(Form("hi_pcal_vz_e_layer2 %d",i+1), Form("hi_pcal_vz_e_layer2 %d",i+1), 300, 0., 900.);
       hi_pcal_vz_e2[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_e2[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_g2[i] = new TH1F(Form("hi_pcal_vz_g_layer2 %d",i+1), Form("hi_pcal_vz_g_layer2 %d",i+1),300, 0., 900.);
       hi_pcal_vz_g2[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_g2[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_h2[i] = new TH1F(Form("hi_pcal_vz_h_layer2 %d",i+1), Form("hi_pcal_vz_h_layer2 %d",i+1),300, 0., 900.);
       hi_pcal_vz_h2[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_h2[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_n2[i] = new TH1F(Form("hi_pcal_vz_n_layer2 %d",i+1), Form("hi_pcal_vz_n_layer2 %d",i+1),300, 0., 900.);
       hi_pcal_vz_n2[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_n2[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_origin_all2[i] = new TH2F(Form("hi_pcal_origin_all_layer2 %d",i+1), Form("hi_pcal_origin_all_layer2 %d",i+1),300, 0., 900.,200, 0., 600.);
       hi_pcal_origin_all2[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_origin_all2[i]->GetYaxis()->SetTitle("R_{vertex} (cm)");
       hi_pcal_edep2[i] = new TH1F(Form("hi_pcal_edep_layer2 %d",i+1), Form("hi_pcal_edep_layer2 %d",i+1),200, 0.,10.);
       hi_pcal_edep2[i]->GetXaxis()->SetTitle("E(MeV)");
       hi_pcal_edep2[i]->GetYaxis()->SetTitle("Rate (MHz/50keV)");
       hi_pcal_occ3[i] = new TH2F(Form("hi_pcal_occ_layer3 %d",i+1), Form("hi_pcal_occ_layer3 %d",i+1),nstrip, 1.,nstrip*1.+1.,3,1.,4.);
       hi_pcal_occ3[i]->GetXaxis()->SetTitle("Strip");
       hi_pcal_occ3[i]->GetYaxis()->SetTitle("View");
       hi_pcal_occ_cut3[i] = new TH2F(Form("hi_pcal_occ_cut_layer3 %d",i+1), Form("hi_pcal_occ_cut_layer3 %d",i+1),nstrip, 1.,nstrip*1.+1.,3,1.,4.);
       hi_pcal_occ_cut3[i]->GetXaxis()->SetTitle("Strip");
       hi_pcal_occ_cut3[i]->GetYaxis()->SetTitle("View");
       hi_pcal_vz_all3[i] = new TH1F(Form("hi_pcal_vz_all_layer3 %d",i+1), Form("hi_pcal_vz_all_layer3 %d",i+1),300, 0., 900.);
       hi_pcal_vz_all3[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_all3[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_e3[i] = new TH1F(Form("hi_pcal_vz_e_layer3 %d",i+1), Form("hi_pcal_vz_e_layer3 %d",i+1), 300, 0., 900.);
       hi_pcal_vz_e3[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_e3[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_g3[i] = new TH1F(Form("hi_pcal_vz_g_layer3 %d",i+1), Form("hi_pcal_vz_g_layer3 %d",i+1),300, 0., 900.);
       hi_pcal_vz_g3[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_g3[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_h3[i] = new TH1F(Form("hi_pcal_vz_h_layer3 %d",i+1), Form("hi_pcal_vz_h_layer3 %d",i+1),300, 0., 900.);
       hi_pcal_vz_h3[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_h3[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_vz_n3[i] = new TH1F(Form("hi_pcal_vz_n_layer3 %d",i+1), Form("hi_pcal_vz_n_layer3 %d",i+1),300, 0., 900.);
       hi_pcal_vz_n3[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_vz_n3[i]->GetYaxis()->SetTitle("Rate (MHz/3cm)");
       hi_pcal_origin_all3[i] = new TH2F(Form("hi_pcal_origin_all_layer3 %d",i+1), Form("hi_pcal_origin_all_layer3 %d",i+1),300, 0., 900.,200, 0., 600.);
       hi_pcal_origin_all3[i]->GetXaxis()->SetTitle("Z_{vertex} (cm)");
       hi_pcal_origin_all3[i]->GetYaxis()->SetTitle("R_{vertex} (cm)");
       hi_pcal_edep3[i] = new TH1F(Form("hi_pcal_edep_layer3 %d",i+1), Form("hi_pcal_pdep_layer3 %d",i+1),200, 0.,10.);
       hi_pcal_edep3[i]->GetXaxis()->SetTitle("E(MeV)");
       hi_pcal_edep3[i]->GetYaxis()->SetTitle("Rate (MHz/50keV)");
   }
...
//       nechit=ec_pid->size();
	   ...
	   if(nsect == 7) nsect = 1;
  	   hi_pcal_occ1[nsect-1]->Fill((*pcal_strip)[i]*1.,(*pcal_view)[i]*1.);
	   ...
	   if((*pcal_Edep)[i]>Ethr) {
	     hi_pcal_occ_cut1[nsect-1]->Fill((*pcal_strip)[i]*1.,(*pcal_view)[i]*1.);
	   }
       }
...
// in luminosity mode (50*2300 or 118600 electrons in 250ns window)
   ...
   for(int i=0; i<6; i++) {
       hi_pcal_occ1[i]->Scale(1000/time/6);
       hi_pcal_occ_cut1[i]->Scale(1000/time/6);
       hi_pcal_vz_all1[i]->Scale(1/time);
       hi_pcal_vz_e1[i]->Scale(1/time);
       hi_pcal_vz_g1[i]->Scale(1/time);
       hi_pcal_vz_h1[i]->Scale(1/time);
       hi_pcal_vz_n1[i]->Scale(1/time);
       hi_pcal_origin_all1[i]->Scale(1/time);
       hi_pcal_edep1[i]->Scale(1/time);
       hi_pcal_occ2[i]->Scale(1000/time/6);
       hi_pcal_occ_cut2[i]->Scale(1000/time/6);
       hi_pcal_vz_all2[i]->Scale(1/time);
       hi_pcal_vz_e2[i]->Scale(1/time);
       hi_pcal_vz_g2[i]->Scale(1/time);
       hi_pcal_vz_h2[i]->Scale(1/time);
       hi_pcal_vz_n2[i]->Scale(1/time);
       hi_pcal_origin_all2[i]->Scale(1/time);
       hi_pcal_edep2[i]->Scale(1/time);
       hi_pcal_occ3[i]->Scale(1000/time/6);
       hi_pcal_occ_cut3[i]->Scale(1000/time/6);
       hi_pcal_vz_all3[i]->Scale(1/time);
       hi_pcal_vz_e3[i]->Scale(1/time);
       hi_pcal_vz_g3[i]->Scale(1/time);
       hi_pcal_vz_h3[i]->Scale(1/time);
       hi_pcal_vz_n3[i]->Scale(1/time);
       hi_pcal_origin_all3[i]->Scale(1/time);
       hi_pcal_edep3[i]->Scale(1/time);
   }
   ...
   for(int i=0; i<6; i++) {
       c_occ1->cd(i+1);
       hi_pcal_occ1[i]->Draw("COLZ");
       for(int iv=0; iv<hi_pcal_occ1[i]->GetNbinsY(); iv++) {
  	   for(int is=0; is<hi_pcal_occ1[i]->GetNbinsX(); is++) {
  	     int layer = i*3+iv+1;
  	     int strip = is +1;
  	     float value = hi_pcal_occ1[i]->GetBinContent(is+1,iv+1);
  	     fprintf(fp,"%d\t%d\t%8.1f\n",layer,strip,value);
  	   }
         }
   }
...
//   c_occ3->Print("ecal_occupancy.pdf");
   ...
   for(int i=0; i<6; i++) {
       c_occ_cut1->cd(i+1);
       hi_pcal_occ_cut1[i]->Draw("COLZ");
       for(int iv=0; iv<hi_pcal_occ_cut1[i]->GetNbinsY(); iv++) {
	   for(int is=0; is<hi_pcal_occ_cut1[i]->GetNbinsX(); is++) {
	     int layer = i*3+iv+1;
	     int strip = is +1;
	     float value = hi_pcal_occ_cut1[i]->GetBinContent(is+1,iv+1);
	     fprintf(fp,"%d\t%d\t%8.1f\n",layer,strip,value);
	   }
       }
   }
...
//   c_occ_cut3->Print("ecal_occupancy.pdf");
   ...
   for(int i=0; i<6; i++) {
       c_origin1->cd(i+1);
       gPad->SetLogz();
       hi_pcal_origin_all1[i]->Draw("COLZ");
   }
...
//   c_origin3->Print("ecal_occupancy.pdf");
   ...
   c_vz1->Divide(3,2);
   c_vz1->cd(1);
   hi_pcal_vz_all1[0]->SetMinimum(0.001);
   hi_pcal_vz_all1[0]->Draw("H");
   hi_pcal_vz_e1[0]->SetLineColor(2);
   hi_pcal_vz_e1[0]->Draw("SAME");
   hi_pcal_vz_g1[0]->SetLineColor(4);
   hi_pcal_vz_g1[0]->Draw("SAME");
   hi_pcal_vz_h1[0]->SetLineColor(kGreen);
   hi_pcal_vz_h1[0]->Draw("SAME");
   hi_pcal_vz_n1[0]->SetLineColor(kGreen+2);
   hi_pcal_vz_n1[0]->Draw("SAME");

    TLegend *leg1 = new TLegend(0.7,0.75,0.96,0.96);
     leg1->SetTextSize(.04);
     leg1->AddEntry(hi_pcal_vz_all1[0],"All","l");
     leg1->AddEntry(hi_pcal_vz_e1[0],"electrons","l");
     leg1->AddEntry(hi_pcal_vz_g1[0],"photons","l");
     leg1->AddEntry(hi_pcal_vz_n1[0],"neutron","l");
     leg1->AddEntry(hi_pcal_vz_h1[0],"hadron","l");
     leg1->Draw();

   c_vz1->cd(2);
   hi_pcal_vz_all1[1]->SetMinimum(0.001);
   hi_pcal_vz_all1[1]->Draw("H");
   hi_pcal_vz_e1[1]->SetLineColor(2);
   hi_pcal_vz_e1[1]->Draw("SAME");
   hi_pcal_vz_g1[1]->SetLineColor(4);
   hi_pcal_vz_g1[1]->Draw("SAME");
   hi_pcal_vz_h1[1]->SetLineColor(kGreen);
   hi_pcal_vz_h1[1]->Draw("SAME");
   hi_pcal_vz_n1[1]->SetLineColor(kGreen+2);
   hi_pcal_vz_n1[1]->Draw("SAME");
	
    TLegend *leg2 = new TLegend(0.7,0.75,0.96,0.96);
     leg2->SetTextSize(.04);
     leg2->AddEntry(hi_pcal_vz_all1[1],"All","l");
     leg2->AddEntry(hi_pcal_vz_e1[1],"electrons","l");
     leg2->AddEntry(hi_pcal_vz_g1[1],"photons","l");
     leg2->AddEntry(hi_pcal_vz_n1[1],"neutron","l");
     leg2->AddEntry(hi_pcal_vz_h1[1],"hadron","l");
     leg2->Draw();

   c_vz1->cd(3);
   hi_pcal_vz_all1[2]->SetMinimum(0.001);
   hi_pcal_vz_all1[2]->Draw("H");
   hi_pcal_vz_e1[2]->SetLineColor(2);
   hi_pcal_vz_e1[2]->Draw("SAME");
   hi_pcal_vz_g1[2]->SetLineColor(4);
   hi_pcal_vz_g1[2]->Draw("SAME");
   hi_pcal_vz_h1[2]->SetLineColor(kGreen);
   hi_pcal_vz_h1[2]->Draw("SAME");
   hi_pcal_vz_n1[2]->SetLineColor(kGreen+2);
   hi_pcal_vz_n1[2]->Draw("SAME");

    TLegend *leg3 = new TLegend(0.7,0.75,0.96,0.96);
     leg3->SetTextSize(.04);
     leg3->AddEntry(hi_pcal_vz_all1[2],"All","l");
     leg3->AddEntry(hi_pcal_vz_e1[2],"electrons","l");
     leg3->AddEntry(hi_pcal_vz_g1[2],"photons","l");
     leg3->AddEntry(hi_pcal_vz_n1[2],"neutron","l");
     leg3->AddEntry(hi_pcal_vz_h1[2],"hadron","l");
     leg3->Draw();

   c_vz1->cd(4);
   hi_pcal_vz_all1[3]->SetMinimum(0.001);
   hi_pcal_vz_all1[3]->Draw("H");
   hi_pcal_vz_e1[3]->SetLineColor(2);
   hi_pcal_vz_e1[3]->Draw("SAME");
   hi_pcal_vz_g1[3]->SetLineColor(4);
   hi_pcal_vz_g1[3]->Draw("SAME");
   hi_pcal_vz_h1[3]->SetLineColor(kGreen);
   hi_pcal_vz_h1[3]->Draw("SAME");
   hi_pcal_vz_n1[3]->SetLineColor(kGreen+2);
   hi_pcal_vz_n1[3]->Draw("SAME");

    TLegend *leg4 = new TLegend(0.7,0.75,0.96,0.96);
     leg4->SetTextSize(.04);
     leg4->AddEntry(hi_pcal_vz_all1[3],"All","l");
     leg4->AddEntry(hi_pcal_vz_e1[3],"electrons","l");
     leg4->AddEntry(hi_pcal_vz_g1[3],"photons","l");
     leg4->AddEntry(hi_pcal_vz_n1[3],"neutron","l");
     leg4->AddEntry(hi_pcal_vz_h1[3],"hadron","l");
     leg4->Draw();

   c_vz1->cd(5);
   hi_pcal_vz_all1[4]->SetMinimum(0.001);
   hi_pcal_vz_all1[4]->Draw("H");
   hi_pcal_vz_e1[4]->SetLineColor(2);
   hi_pcal_vz_e1[4]->Draw("SAME");
   hi_pcal_vz_g1[4]->SetLineColor(4);
   hi_pcal_vz_g1[4]->Draw("SAME");
   hi_pcal_vz_h1[4]->SetLineColor(kGreen);
   hi_pcal_vz_h1[4]->Draw("SAME");
   hi_pcal_vz_n1[4]->SetLineColor(kGreen+2);
   hi_pcal_vz_n1[4]->Draw("SAME");

    TLegend *leg5 = new TLegend(0.7,0.75,0.96,0.96);
     leg5->SetTextSize(.04);
     leg5->AddEntry(hi_pcal_vz_all1[4],"All","l");
     leg5->AddEntry(hi_pcal_vz_e1[4],"electrons","l");
     leg5->AddEntry(hi_pcal_vz_g1[4],"photons","l");
     leg5->AddEntry(hi_pcal_vz_n1[4],"neutron","l");
     leg5->AddEntry(hi_pcal_vz_h1[4],"hadron","l");
     leg5->Draw();

   c_vz1->cd(6);
   hi_pcal_vz_all1[5]->SetMinimum(0.001);
   hi_pcal_vz_all1[5]->Draw("H");
   hi_pcal_vz_e1[5]->SetLineColor(2);
   hi_pcal_vz_e1[5]->Draw("SAME");
   hi_pcal_vz_g1[5]->SetLineColor(4);
   hi_pcal_vz_g1[5]->Draw("SAME");
   hi_pcal_vz_h1[5]->SetLineColor(kGreen);
   hi_pcal_vz_h1[5]->Draw("SAME");
   hi_pcal_vz_n1[5]->SetLineColor(kGreen+2);
   hi_pcal_vz_n1[5]->Draw("SAME");
	
    TLegend *leg6 = new TLegend(0.7,0.75,0.96,0.96);
     leg6->SetTextSize(.04);
     leg6->AddEntry(hi_pcal_vz_all1[5],"All","l");
     leg6->AddEntry(hi_pcal_vz_e1[5],"electrons","l");
     leg6->AddEntry(hi_pcal_vz_g1[5],"photons","l");
     leg6->AddEntry(hi_pcal_vz_n1[5],"neutron","l");
     leg6->AddEntry(hi_pcal_vz_h1[5],"hadron","l");
     leg6->Draw();
